...
[installation](https://mongodb.com/docs/manual/installation/) page for
details.

Next, you may wish to take a look at the [MongoDB
Manual](https://mongodb.com/docs/manual/) for a language independent look at
how to use MongoDB. Also, we suggest some basic familiarity with the [mongo
shell](https://mongodb.com/docs/manual/mongo/) – the shell is the primary
...
operations documentation](https://mongodb.com/docs/manual/core/write-operations/#write-concern).
...
docs](https://mongodb.com/docs/manual/indexes/).
...
Documents Tutorial](https://mongodb.com/docs/manual/tutorial/modify-documents/).
...
are many more capabilities. For further exploration:
 ...
 - See the language-independent [MongoDB Manual](https://mongodb.com/docs/manual/)
 - Experiment with the [mongo shell](https://mongodb.com/docs/manual/mongo/)
