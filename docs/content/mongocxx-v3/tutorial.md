...
- A [mongod](https://mongodb.com/docs/manual/reference/program/mongod/)
...
[MongoDB URI](https://mongodb.com/docs/manual/reference/connection-string/),
...
To create an [index](https://mongodb.com/docs/manual/indexes/) on a
