...
class MONGOCXX_API client_encryption {
   public:
    ...
    ///
    /// @see https://mongodb.com/docs/ecosystem/use-cases/client-side-field-level-encryption-guide
    ///
    ...
    ///
    /// @see
    /// https://mongodb.com/docs/ecosystem/use-cases/client-side-field-level-encryption-guide/#b-create-a-data-encryption-key
    ///
    ...
    ///
    /// @see
    /// https://mongodb.com/docs/manual/reference/method/ClientEncryption.encrypt/#ClientEncryption.encrypt
    ///
    ...
    ///
    /// @see
    /// https://mongodb.com/docs/manual/reference/method/ClientEncryption.decrypt/#ClientEncryption.decrypt
    ///
