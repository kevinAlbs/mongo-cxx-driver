...
# TODO: test with extra alignment on and off. -DENABLE_EXTRA_ALIGNMENT=OFF
CMAKE_ARGS="
...
case "$OS" in
    ...
    # TODO: temp - just check that this works before refactoring config.
        ...
        "/cygdrive/c/Program Files (x86)/Microsoft Visual Studio/2017/Professional/MSBuild/15.0/Bin/MSBuild.exe" /m INSTALL.vcxproj
        ;;
