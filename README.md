...
* [MongoDB Database Manual](https://mongodb.com/docs/manual/)
...
Compatibility of each C++ driver version with each MongoDB server is documented in the [MongoDB manual](https://mongodb.com/docs/drivers/cxx#mongodb-compatibility).
